        ...
        <div className="flex flex-col gap-5 md:flex-row md:gap-12 lg:gap-20">
          ...
          <div className="w-full max-w-lg">
            <p className="header-description text-muted-foreground md:text-md">
              Turn your home EV charger into a source of income by sharing it
              with drivers in your area. Our platform makes it easy to list your
              charger, set your rates, and manage bookings.
            </p>
