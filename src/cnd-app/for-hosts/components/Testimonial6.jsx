    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 bg-muted/40">
      <div className="container">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <Card className="flex h-full w-full max-w-md flex-col items-center justify-between text-center mx-auto p-6 bg-muted/40">
            <div className="mb-6 flex md:mb-8">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="size-6 text-malachite" />
              ))}
            </div>
          ...
          <Card className="flex h-full w-full max-w-md flex-col items-center justify-between text-center mx-auto p-6 bg-muted/40">
            ...
            <div className="mt-6 flex h-full w-full max-w-md flex-col items-center justify-between text-center mx-auto">
              <div className="mb-3 md:mb-4">
